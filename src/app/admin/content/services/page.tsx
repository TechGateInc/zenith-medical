...
export default function AdminServicesPage() {
  ...
  function handleIconSelect(iconName: string) {
    ...
    if (iconName === "Custom") {
      ...
      setShowCustomIcon(false)
      const selectedIconData = MEDICAL_ICONS.find(icon => icon.name === iconName)
      if (selectedIconData) {
        ...
        <div className="mb-4">
          ...
          <div className="mb-3">
            ...
            <div className="grid grid-cols-6 gap-2 mb-3">
              {MEDICAL_ICONS.filter(icon => icon.name !== "Custom").map((icon) => (
                <button
                  key={icon.name}
                  type="button"
          ...
          <div className="mb-3">
            <label className="block text-sm font-medium mb-1">Or select from dropdown:</label>
            <select
              className="w-full border rounded px-3 py-2"
              value={selectedIcon}
          ...
          {showCustomIcon && (
            <div className="mb-3">
              <label className="block text-sm font-medium mb-1">Custom SVG Icon</label>
              <textarea
