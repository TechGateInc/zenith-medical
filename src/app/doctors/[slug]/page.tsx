...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      ...
      doctor.bio ||
      `Meet ${doctor.name}, ${doctor.title} at Zenith Medical Centre.`,
    openGraph: {
    ...
    <Layout>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(doctorStructuredData),
        }}
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href={doctor.doctor?.bookingUrl || appointmentBookingUrl}
                  target="_blank"
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  {doctor.doctor.graduationYear && (
                    <p className="text-sm text-slate-500 mt-2">
                      Graduated {doctor.doctor.graduationYear}
                    </p>
                  )}
                </div>
              )}
      ...
      {doctor.doctor &&
        ((doctor.doctor.boardCertifications &&
          doctor.doctor.boardCertifications.length > 0) ||
          (doctor.doctor.memberships &&
            doctor.doctor.memberships.length > 0)) && (
          <section className="py-16 lg:py-24 bg-gray-50">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-slate-800 mb-4">
                  ...
                  doctor.doctor.boardCertifications.length > 0 && (
                    <div>
                      ...
                      <div className="space-y-2">
                        {doctor.doctor.boardCertifications.map(
                          (cert, index) => (
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-600 mb-8">
            Book an appointment and experience exceptional care from our
            experienced healthcare professional.
          </p>
