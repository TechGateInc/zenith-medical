...
const baseUrl =
  process.env.NEXT_PUBLIC_BASE_URL || "https://www.zenithmedical.ca";
...
export const metadata: Metadata = {
  ...
  description:
    "Quality family medicine and healthcare services in Medical District, MD. Preventive care, chronic disease management, and comprehensive health services for all ages.",
  keywords:
    "family medicine, healthcare, medical center, doctor, physician, health clinic, primary care, Medical District MD",
