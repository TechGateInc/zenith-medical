        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <div>
                <div className="text-xl font-bold">Zenith Medical Centre</div>
                <div className="text-sm text-gray-300">Comprehensive Family Healthcare</div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <div>
                  <div className="text-white">123 Healthcare Drive</div>
                  <div className="text-gray-300 text-sm">Medical District, MD 21201</div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="text-white">(555) 123-CARE</div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="text-white">info@zenithmedical.com</div>
